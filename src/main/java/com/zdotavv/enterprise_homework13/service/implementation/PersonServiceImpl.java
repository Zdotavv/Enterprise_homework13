...
import com.zdotavv.enterprise_homework13.model.Role;
import com.zdotavv.enterprise_homework13.repository.PersonRepository;
import com.zdotavv.enterprise_homework13.service.interfaces.EmailService;
...
public class PersonServiceImpl implements PersonService {
    ...
    public Person createPerson(String firstName, String lastName, String email, String username, String password) {
        ...
        if (personRepository.existsById(newPerson.getIdPerson())){
